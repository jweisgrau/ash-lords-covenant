(function () {
    ...
    function processStateUpdateLogic(currentState, update) {
    ...
    // Expose pure logic modules to the global scope under a unique namespace
    window.PureGameLogic = {
        MechanicsEngine,
        InventorySystem,
        OracleSystem,
        TagSystem,
        processStateUpdateLogic
    };
})();
